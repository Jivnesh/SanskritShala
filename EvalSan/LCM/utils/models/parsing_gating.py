...
class BiAffine_Parser_Gated(nn.Module):
    ...
    def decode(self,model_path, input_word, input_pos, input_lemma, out_arc, out_arc_tag, mask=None, length=None, leading_symbolic=0):
    ...
    def constrained_decode(self,model_path, input_word, input_pos, input_lemma, out_arc, out_arc_tag, mask=None, length=None, leading_symbolic=0):
...
class BiAffine_Parser_Decoder(nn.Module):
    ...
    def unconstrained_decode_mst(self,model_path, input_word, input_pos, input_lemma, out_arc, out_arc_tag, mask, length, leading_symbolic):
