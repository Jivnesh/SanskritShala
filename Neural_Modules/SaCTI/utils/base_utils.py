...
import requests
import zipfile
from utils.mwt_lemma_utils.seq2seq_utils import *
from utils.mwt_lemma_utils.seq2seq_vocabs import *
import math
...
def tget_output_doc(conllu_doc):
    ...
    for sent_id in range(num_sents):
        ...
        out_sent = []
        # print("jig jisg aisasiasiasiaisiasiias ",sent)
        ...
        for word_id in range(1, num_words + 1):
            ...
            out_sent.append({ID: f'{word_id}', TEXT: word[TEXT],
                             ...
                             HEADG: word.get(HEADG, f'{word_id - 1}'), DEPRELG: word.get(DEPRELG, '_')})
